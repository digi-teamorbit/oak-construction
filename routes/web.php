...
Route::get('/alterations-york', 'HomeController@alterationsYork')->name('alterations_york');
Route::get('/contact', 'HomeController@contact')->name('contact');
Route::get('/project', 'HomeController@project')->name('project');
Route::get('/project_category/{category}', 'HomeController@category')->name('category');
// Route::get('/project1', 'HomeController@project1')->name('project1');
// Route::get('/project2', 'HomeController@project2')->name('project2');
Route::get('/services', 'HomeController@services')->name('services');
Route::get('/services/{services}', 'HomeController@singleService')->name('single_service');
Route::get('/project/{project}', 'HomeController@singleProject')->name('single_project');
...
Route::resource('admin/project-category', 'Admin\\ProjectCategoryController');
