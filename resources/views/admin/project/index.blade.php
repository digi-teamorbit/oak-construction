    ...
    <div class="container-fluid bg-white mt-5">
        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <div class="card-body">
                    <h3 class="box-title pull-left">Project</h3>
                    
                        <a class="btn btn-success pull-right" href="{{ url('/admin/project/create') }}"><i
                                    class="icon-plus"></i> Add Project</a>
                            ...
                            @foreach($project as $item)
                                <tr class="text-center">
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ url('/admin/project/' . $item->id) }}"
                                               title="View Project">
