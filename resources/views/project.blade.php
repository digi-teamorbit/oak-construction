        ...
        <div class="row">
          <div class="col-md-4 col-sm-4 col-xs-12">
            <div class="project-Tabs">
              <ul>
                <li><a href="{{route('project')}}" class="{{ request()->is('project') ? 'active' : '' }}">All</a></li>
                @foreach ($project_categories as $category)
                <li><a href="{{route('category', $category->id)}}" class="{{ request()->is('project_category/'.$category->id) ? 'active' : '' }}">{{$category->category_name}}</a></li>
                @endforeach
...
<!--                 <li><a href="javascript:void(0)">Bathroom Design and installation Service</a></li>
          ...
          <div class="col-md-8 col-sm-8 col-xs-12">
            <div class="row">
              ...
              <div class="col-sm-10">
                <h1><strong>No Project Found!</strong></h1>
              </div>
              <div class="col-sm-1">
              ...
              <div class="col-sm-4">
                <div class="project-box wow zoomIn" data-wow-delay="0.4s" data-wow-duration="2s">
                  <img src="{{asset($project->image)}}" class="img-responsive" alt="rps1b-img1">
                  <h3><a href="{{route('single_project', $project->id)}}">{{$project->title}}</a></h3>
                </div>
              </div>
              @endforeach
              @endif
              <!-- <div class="col-sm-4">
                <div class="project-box wow zoomIn" data-wow-delay="0.4s" data-wow-duration="2s">
                  ...
                  <h3><a href="">Lorem ipsum dolo</a></h3>
                </div>
              </div> -->
              <!-- <div class="col-sm-4">
                <div class="project-box wow zoomIn" data-wow-delay="0.4s" data-wow-duration="2s">
