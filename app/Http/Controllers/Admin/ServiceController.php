...
class ServiceController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if(auth()->user()->permissions()->where('name','=','add-'.$model)->first()!= null) {
            ...
            if ($request->hasFile('icon')) {
                ...
                $service->icon = $service_path.$profileImage;
            }
    ...
    public function update(Request $request, $id)
    {
        ...
        if(auth()->user()->permissions()->where('name','=','edit-'.$model)->first()!= null) {
            ...
            $image_path = public_path($service->icon); 
            ...
            $file = $request->file('icon');
            $fileNameExt = $request->file('icon')->getClientOriginalName();
            $fileNameForm = str_replace(' ', '_', $fileNameExt);
            $fileName = pathinfo($fileNameForm, PATHINFO_FILENAME);
            $fileExt = $request->file('icon')->getClientOriginalExtension();
            $fileNameToStore = $fileName.'_'.time().'.'.$fileExt;
            $pathToStore = public_path('uploads/services/');
            Image::make($file)->save($pathToStore . DIRECTORY_SEPARATOR. $fileNameToStore);

             $requestData['icon'] = 'uploads/services/'.$fileNameToStore;               
        }
